        ...
        if(args.length() > 0) {
            ...
            for(int i=0; i<args.length(); i++) {
                ...
                try {
                    ...
                    VENDA_ITENS_REDE=((char) 0x1B) + "" + ((char) 0x6A) + "0" + LIVE_ITENS_PRODUTOID 
                    + "" +((char) 0x20) +((char) 0x20) 
                    ...
                    + "" + LIVE_ITENS_VLR_UNIT + ((char) 0x20) + ((char) 0x20) + "   " + LIVE_ITENS_VLR_TOTAL + ((char) 0x0A); 
                        ...
                        VENDA_ITENS_REDE=((char) 0x1B)+"a0"+ LIVE_ITENS_PRODUTOID 
                    +((char) 0x20) +((char) 0x20) 
                    + LIVE_ITENS_DESCRICAO 
                    + ((char) 0x0A)
                    + ((char) 0x1B)+"a2" 
...
//http://www.technotalkative.com/android-json-parsing/
		...
		//versao.setText(String.valueOf(obj.retornaVersao()));
			...
			objeto.enviarComando(+ ((char) 0x1B) + "@"
                    ...
                    + ((char) 0x0A)             
                    + ACRES_DESC             
                    + ((char) 0x1B)+"a0" + ((char) 0x08) + "Valor a Pagar R$                         " + VLR_RECEBER
                    + ((char) 0x0A)
